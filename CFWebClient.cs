...
{
    public class CFWebClient : WebClient
    {
        ...
        public CFWebClient(params Cookie[] cookies)
        {
        ...
        public CFWebClient(CookieContainer cookies = null, bool autoRedirect = true)
        {
        ...
        protected override WebRequest GetWebRequest(Uri address)
        {
            ...
            if (_request != null)
            {
                httpRequest.UserAgent = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:54.0) Gecko/20100101 Firefox/54.0";
        ...
        private WebResponse BypassCloudflare(HttpWebRequest request, HttpWebResponse response)
        {
            ...
            string newurl = CFInterpreter.Interpret(response.ResponseUri.AbsoluteUri, html);
